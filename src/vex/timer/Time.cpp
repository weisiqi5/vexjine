...
//    cout << "adding garbage collection time " << (getRealTime() - lastBackgroundLoadExecutionTime) /1e6 << " ms" <<endl;
...
/*
 * Open file with sample delays of bytecode instrumentation and get the delay values
 */
